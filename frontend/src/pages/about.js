  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content="About Us | Starlink Education and Visa Services"
        />
        <meta
        ...
        <section className="mb-16 md:mb-24">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="mt-3 md:mt-4 text-gray-600 max-w-2xl mx-auto text-sm md:text-base">
              Comprehensive support for every step of your Australian education
              journey
            </p>
          </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 md:gap-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm md:text-base">
                    Officially registered with Australian authorities (ABN:
                    679958322) for reliable advice.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm md:text-base">
                    98% visa success rate with hundreds of satisfied students
                    across Australia.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm md:text-base">
                    We prioritize your best interests, not institutional
                    commissions.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm md:text-base">
                    Continuous assistance from application through to your
...
const OfficeCard = ({ location, address, hours, phone }) => {
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8 max-w-sm mx-auto">
      ...
      <div className="space-y-4 text-gray-600 text-sm md:text-base">
        <p className="flex items-start">
          <svg
            className="w-5 h-5 mr-3 text-green-600 mt-1"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
